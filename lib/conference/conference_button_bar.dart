  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: GestureDetector(
        key: const Key('show-hide-button-bar-gesture'),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          CircleButton(
            key: const Key('microphone-button'),
          ...
          CircleButton(
            key: const Key('toggle-speaker-button'),
          ...
          if (hasFlash)
            CircleButton(
              key: const Key('toggle-flashlight-button'),
